...
;(function($, window, document) {
	...
	DialogBox.prototype = {
		...
		create: function(element) {
			...
			if(!hasBtn) {
				...
				if(confirmValue && cancelValue) {
					...
					dialogHTML[1] = '<div class="dialog-btn"><span class="dialog-btn-confirm">' + confirmValue + '</span><span class="dialog-btn-confirm">' + confirmValue + '</span></div></div></section>';
				} else {
		...
		trigger: function(element, event) {
			var that = this,
				$this = $(element);
			//if(window.location.host == "zh.xuehuiwang.com") {
